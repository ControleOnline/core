...
class Country
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Core\Entity\LanguageCountry", mappedBy="country")
     */
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="Core\Entity\State", mappedBy="country")
     */
    private $state;
     ...
     * @return Country
     */
    public function addState(\Core\Entity\State $state)
    {
        $this->state[] = $state;
     ...
     * @param \Core\Entity\State $state
     */
    public function removeState(\Core\Entity\State $state)
    {
