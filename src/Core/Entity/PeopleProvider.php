...
class PeopleProvider {
     ...
     *
     * @ORM\ManyToOne(targetEntity="Core\Entity\People", inversedBy="peopleProvider")
     * @ORM\JoinColumns({
     ...
     * Set provider
     *
     * @param \Core\Entity\Provider $provider
     * @return PeopleProvider
     */
    public function setProvider(\Core\Entity\Provider $provider = null) {
